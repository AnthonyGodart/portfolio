...
function Introduction(){
    return(
        <main className={styles.container}>
            ...
            Avec 14 ans d'expérience dans l'industrie de la maintenance automobile, j'ai récemment pris une décision audacieuse : me reconvertir en tant que Développeur web. <br />
